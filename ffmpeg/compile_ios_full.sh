...
--extra-cflags="-iwithsysroot /usr/include/libxml2 -arch $ARCH -miphoneos-version-min=9.0 -I$OPENSSL_HEADS -I$X264_HEADS -I$SRT_HEADS -I$RIST_HEADS" \
--extra-ldflags="-arch $ARCH -miphoneos-version-min=9.0 -Wl,-dead_strip -L$OPENSSL_LIBS -L$X264_LIBS -L$SRT_LIBS -L$RIST_LIBS" \
--extra-libs="-lrist -lsrt -lssl -lcrypto -lx264"
