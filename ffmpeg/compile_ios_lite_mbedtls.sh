...
MBEDTLS_HEADS=$DEPS_DIR/mbedtls/include
MBEDTLS_LIBS=$DEPS_DIR/mbedtls/lib
...
--extra-cflags="-iwithsysroot /usr/include/libxml2 -arch $ARCH -miphoneos-version-min=9.0 -I$MBEDTLS_HEADS -I$X264_HEADS" \
--extra-ldflags="-arch $ARCH -miphoneos-version-min=9.0 -Wl,-dead_strip -L$MBEDTLS_LIBS -L$X264_LIBS" \
--extra-libs="-lmbedcrypto -lmbedtls -lmbedx509 -lx264"
